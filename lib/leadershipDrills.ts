...
export const leadershipDrills: LeadershipDrill[] = [
  ...
  },
  {
    ...
    modelAnswer:
      'Allocating resources is among a leader’s most critical duties. It means deciding how to distribute the organisation’s limited resources, and those resources fall into four categories often called the "4 Ms": Man (people or human resources), Money, Materials, and Time. How a leader shares out these four resources largely determines which projects are prioritised, which departments thrive, and whether the organisation reaches its strategic goals.\n\n' +
      ...
      'Poor allocation produces the opposite. Assigning underqualified staff to critical tasks invites delays, safety risks, and reputational damage. Underfunding maintenance or quality assurance leads to equipment breakdowns and unhappy clients. Cheap substitute materials can compromise structural integrity, and rushing to meet an unrealistic deadline causes poor workmanship and staff burnout. For these reasons a leader should allocate resources thoughtfully - with foresight, fairness, and a willingness to be held accountable - because the way resources are shared out ends up deciding which work is completed and which is left undone.',
  },
  {
    id: 'lddr-003',
    topic: 'concepts',
  ...
  },
  {
    ...
    rubric: [
      ...
      { id: 'r3', label: 'How to balance the two', detail: 'Explains balancing the styles across the three areas the note names: how decisions are made, how authority is shown, and how the leader communicates with people.', marks: 2 },
    ],
    modelAnswer:
