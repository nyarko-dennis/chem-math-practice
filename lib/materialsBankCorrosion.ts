...
export const corrosionAdvancedQuestions: MaterialsQuestion[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      'Reinforced concrete: hard stone or gravel particles set inside a cement-paste matrix',
  ...
  },
  {
    ...
    topic: 'corrosionAdvanced',
    type: 'mcq',
    prompt: 'A pane of "smart glass" darkens when light shining on it changes, without any wiring or electric field involved. Which class of smart material best fits behavior like this, as distinct from piezoelectric or magnetostrictive materials?',
    choices: [
      'A magnetostrictive material, which changes shape only in response to a magnetic field',
      'A piezoelectric material, which only produces a voltage under mechanical pressure',
      'A photochromic or thermochromic material, which shifts its color or tint in response to changes in light or temperature rather than to pressure or magnetism',
      'A plain glass with no special material behavior at all',
    ],
    correctIndex: 2,
    rationale:
      'Photochromic materials darken or lighten with changing light levels and thermochromic materials shift color with temperature, so unlike piezoelectric materials (pressure to voltage) or magnetostrictive materials (magnetic field to shape change), these respond to light or heat.',
  },
  {
    id: 'ca-027',
    topic: 'corrosionAdvanced',
    type: 'mcq',
    prompt: 'A polymer coating is engineered so that when a tiny crack starts to form inside it, the material itself seals the crack shut without any outside repair. What is this behavior called?',
    choices: [
      'Magnetostriction',
      'Thermochromic behavior',
      'Galvanising',
      'Self-healing behavior, where the material can fix small internal damage on its own',
    ],
    correctIndex: 3,
    rationale:
      'A self-healing material is designed so that tiny internal cracks trigger the material to seal itself back up, extending its working life without anyone stepping in to patch it manually.',
  },
  {
    id: 'ca-028',
    topic: 'corrosionAdvanced',
